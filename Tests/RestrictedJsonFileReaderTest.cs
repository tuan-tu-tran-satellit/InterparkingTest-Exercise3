...
{
    [TestClass]
    public class RestrictedJsonFileReaderTest
    {
        [TestMethod]
        public void ItCanEnforceASecurityPolicy()
        {
            ...
            var restrictedReader = new RestrictedJsonFileReader(securityPolicy.Object);
        ...
        [TestMethod]
        public void It_Can_Read_JsonFiles_If_The_SecurityContext_Allows_It()
        {
            //Arrange
            var securityPolicy = new Mock<ISecurityContext>(MockBehavior.Strict);
            ...
            var fakeReader = new FakeReader { Content = "{'some':['json','content']}" };

            var restrictedReader = new RestrictedJsonFileReader(securityPolicy.Object, fakeReader);
        ...
        [TestMethod]
        public void It_Validates_The_JsonContent_When_Allowed_By_The_SecurityContext()
        {
            //Arrange
            var securityPolicy = new Mock<ISecurityContext>(MockBehavior.Strict);
            ...
            var fakeReader = new FakeReader { Content = "not json content" };
